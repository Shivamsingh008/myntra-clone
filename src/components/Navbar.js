  ...
  return (
    <div className="bg-white shadow-lg">
      <div className="flex items-center md:justify-evenly justify-around">
        ...
        {/* //md:w-16 md:h-16 w-[400px] h-[60px] md:ml-5 ml-1 */}
        {menu && (
          <div className="md:static absolute z-20 bg-gray-200  md:min-h-fit min-h-[40vh] left-0 top-[7%] md:w-auto w-[382px] flex items-center px-2 ">
        ...
        {menu ? (
          <div className="flex items-center cursor-pointer md:hidden">
            <IoClose onClick={() => setmenu(!menu)} className=" text-[40px]" />
          </div>
        ) : (
          <div className="flex items-center cursor-pointer md:hidden">
            <CgMenuRightAlt
